...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    ftp_push: {
      your_target: {
        options: {
          ...
          // port: 21,
          dest: '/mash-tun.net/rasmussen/meta2/'
        },
    ...
    buildcontrol: {
      ...
      stage: {
        options: {
          remote: 'clafro2@forsyth.dreamhost.com:mash-tun.net/rasmussen/meta2/.git',
          branch: 'master'
        }
      },
      local: {
    ...
    compress: {
      main: {
        options: {
          archive: 'zips/meta2-'+grunt.template.today('yyyymmdd-HHMM')+'.zip'
        },
        files: [
          {src: ['dist/**'], dest: ''}
        ]
